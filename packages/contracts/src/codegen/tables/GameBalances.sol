...
library GameBalances {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "games", name: "GameBalances", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d657300000000000000000047616d6542616c616e63657300000000);
