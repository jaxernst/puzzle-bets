...
library BuyInCurrencyAddress {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "games", name: "BuyInCurrencyAdd", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d6573000000000000000000427579496e43757272656e6379416464);
