...
// Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "BuyIn", typeId: RESOURCE_TABLE });`
ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000427579496e0000000000000000000000);
ResourceId constant BuyInTableId = _tableId;
