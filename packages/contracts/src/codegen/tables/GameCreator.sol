...
library GameCreator {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "games", name: "GameCreator", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d657300000000000000000047616d6543726561746f720000000000);
