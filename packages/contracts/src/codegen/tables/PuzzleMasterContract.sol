...
library PuzzleMasterContract {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "games", name: "PuzzleMasterCont", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267616d657300000000000000000050757a7a6c654d6173746572436f6e74);
